...
},{"./pages/axios":"hQX9p","./pages/hero":"gP8Wk","./pages/top":"hpkuE","./pages/genres":"5pj3C"}],"hQX9p":[function(require,module,exports) {
"use strict";
...
exports.api = axios_1.default.create({
    ...
    params: {
        "api_key": secret_1.APIKEY
    }
});

},{"axios":"jo6P5","../secret":"kjLud"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"kjLud":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"gP8Wk":[function(require,module,exports) {
"use strict";
var __awaiter = this && this.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
class Hero {
    ...
    getUpcomingMovies() {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            movies.forEach((movie, index)=>{
                if (movie.poster_path != null) this.movieList.push({
                    title: movie.title,
    ...
    populateimg(selected) {
        ...
        for(let i1 = selected - 1; i1 <= selected + 1; i1++){
            ...
            if (i1 < 0) {
                img.setAttribute("src", "https://image.tmdb.org/t/p/original/" + this.movieList[this.movieList.length + i1]["backdrop_path"]);
                img.setAttribute("alt", this.movieList[this.movieList.length + i1]["title"] + " poster image");
                img.setAttribute("id", "image" + (this.movieList.length + i1));
                img.addEventListener("click", ()=>this.Navigatemovies(this.movieList.length + i1), false);
            } else if (i1 == selected) {
                img.setAttribute("src", "https://image.tmdb.org/t/p/original/" + this.movieList[i1]["backdrop_path"]);
                img.setAttribute("alt", this.movieList[i1]["title"] + " poster image");
                img.setAttribute("id", "image" + i1);
            } else if (i1 > this.movieList.length - 1) {
                img.setAttribute("src", "https://image.tmdb.org/t/p/original/" + this.movieList[i1 - this.movieList.length]["backdrop_path"]);
                img.setAttribute("alt", this.movieList[i1 - this.movieList.length]["title"] + " poster image");
                img.setAttribute("id", "image" + (i1 - this.movieList.length));
...
},{"./axios":"hQX9p"}],"hpkuE":[function(require,module,exports) {
"use strict";
var __awaiter = this && this.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
},{"./axios":"hQX9p"}],"5pj3C":[function(require,module,exports) {
"use strict";
var __awaiter = this && this.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
},{"./axios":"hQX9p"}]},["7dx30","lbDgN"], "lbDgN", "parcelRequireace1")
